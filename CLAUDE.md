...
| `김민수 - 노터스타일 - 예비창업패키지 사업계획서.pdf` | 예비창업패키지 사업계획서 (시장 분석, 수익 모델, 사업 로드맵, 법적 검토) |
...
> 📘 **상세 내용**: [docs/PRD.md](docs/PRD.md) 섹션 8 참조

| 수익 모델 | 내용 | 수익창출 방식 |
|----------|------|-------------|
| 플랫폼 월 구독료 | 매장 관리 플랫폼 월 사용료 (월 2~3만원) | 정기구독료 |
| AI 페이스 스왑 이용권 | AI 마케팅 콘텐츠 제작 서비스 | 부가 서비스 / 무료 제공 후 초과시 과금 |
| 미용 기자재 업체 입점 수수료 | 온라인 기자재 판매 O2O | 수수료 / 광고비용 |
| PB 상품 판매 | 자체 제작 PB 상품 판매 | 판매 수익금 |
| 미용 취업 알선 수익 | AI 기반 구인구직 매칭 | 채용공고 작성권 / 포트폴리오 조회권 |
| 카드단말기 제휴 | 결제액 수익 공유 | 제휴 수익 |

### 프로모션 정책
- 신규 도입 시 월 사용료 **3개월 무료**
- Face swap **10건 무료** + SNS 공유 시 **20건 추가**
