  ...
  return (
    <div>
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-6">
        <h1 className="text-xl font-bold text-gray-900">Note-a-Style</h1>
        <p className="text-sm text-gray-500 mt-1">시술 기록의 신</p>
      </div>
      ...
      <div className="px-4 -mt-4">
        <div className="bg-gray-50 rounded-2xl border border-gray-200 p-4">
          <div className="grid grid-cols-2 gap-3">
            <Link
              href="/record"
              className="flex items-center gap-3 p-4 rounded-xl bg-white border border-gray-200 active:scale-95 transition-transform"
            >
              ...
              <div>
                <div className="font-bold text-sm text-gray-900">빠른 기록</div>
            ...
            >
              ...
              <div>
                <div className="font-bold text-sm text-gray-900">상세 기록</div>
      ...
      <div className="px-4 mt-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/treatments" className="text-sm text-gray-500">
            전체보기
          </Link>
        </div>
        {loading ? (
...
function TreatmentCard({ treatment: t }: { treatment: Treatment }) {
  return (
    <Link
      ...
      className="block bg-gray-50 rounded-xl border border-gray-200 p-3 active:bg-gray-100"
    >
      <div className="flex items-center justify-between">
        <div>
          <span className="text-sm font-medium text-gray-900">{t.service_type}</span>
          {t.service_detail && (
